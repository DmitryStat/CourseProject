package com.example.notepadby.remindme.dialog;
...
public class EditTaskDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (task.getDate() != 0) {
            ...
            etTime.setText(Utils.getTime(task.getTimeStamp()));
        }
        ...
        ArrayAdapter<String> priorityAdapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_dropdown_item, ModelTask.PRIORITY_LEVELS);
